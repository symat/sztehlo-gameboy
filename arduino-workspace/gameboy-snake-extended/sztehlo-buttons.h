...
#define _BUTTON_UP_BIT 3
#define _BUTTON_DOWN_BIT 5
#define _BUTTON_LEFT_BIT 4
#define _BUTTON_RIGHT_BIT 0
#define _BUTTON_ACTION_1_BIT 2
#define _BUTTON_ACTION_2_BIT 1
...
void buttonsReadAllInputs() { 
  ...
  buttonsReadInput(PORT_SW_A, &btn_right_btn1_btn2, _BUTTON_RIGHT_BIT, _BUTTON_ACTION_1_BIT, _BUTTON_ACTION_2_BIT);
  buttonsReadInput(PORT_SW_B, &btn_up_left_down, _BUTTON_UP_BIT, _BUTTON_LEFT_BIT, _BUTTON_DOWN_BIT);
}
