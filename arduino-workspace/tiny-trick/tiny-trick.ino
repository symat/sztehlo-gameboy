...
for (x = 0; x < 128; x++){TinyOLED_Send(Recupe(x,y));}
TinyOLED_End();
}}
...
for (x = 0; x < 128; x++){
switch(GOAL_SCREEN){
  case 0:TinyOLED_Send((pgm_read_byte(&Intro[(x)+(y*128)])|blitzSprite(40,39,x,y,0,cadre40_37)));break;
  case 1:TinyOLED_Send(((Recupe(x,y)|(blitzSprite(40,39+SLIDE,x,y,0,screen)))&(0xff-blitzSprite(40,39+SLIDE,x,y,1,screen)))|(blitzSprite(40+(13),39+SLIDE+(13),x,y,Points_Pl1,NUM)|blitzSprite(40+(33),39+SLIDE+(13),x,y,Points_CPU,NUM)));break;
  case 2:TinyOLED_Send(Lost_win(x,y,win));break;
  case 3:TinyOLED_Send(Lost_win(x,y,lost));break;
  case 4:TinyOLED_Send(pgm_read_byte(&Intro[(x)+(y*128)]));break;
  default:break;
}}
TinyOLED_End();
}}
