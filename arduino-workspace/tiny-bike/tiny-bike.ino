...
void Tiny_Flip(uint8_t MODE) {
  ...
  for (y = PRINT; y < PRINT2; y++) {
    ...
    for (x = 0; x < 128; x++) {
      switch (MODE) {
        case 0:
        case 1: TinyOLED_Send(Recupe(x, y)); break;
        case 2: TinyOLED_Send(((blitzSprite(38, 30, x, y, 0, INTROPIC)))); break;
        case 3: TinyOLED_Send(Recupe(x, y)); break;
        default: break;
      }
    }
    TinyOLED_End();
